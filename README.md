...
* Routing Strategy: High-current paths (VCC/BAT) are routed using wide tracks or **Polygon Pours** to ensure current carrying capacity and minimize voltage drop.
